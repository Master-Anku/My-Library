let questions = [
    {
      question: "JavaScript ဆိုတာဘာလဲ?",
      options: ["programming language။", "markup language", "operating system "],
      answer: "programming language",
    },
    {
      question: "var က  ဘာ (scope) လဲ။",
      options: ["function-scope", "block-scope", "global-scope"],
      answer: "global-scope",
    },
    {
      question: "let က ဘာ (scope) လဲ။",
      options: ["global-scope", "block-scope", "local-scope"],
      answer: "block-scope",
    },
    {
      question: "scope ဘယ်နှစ်မျိုးလဲ။ ",
      options: ["၅", "၄", "၆"],
      answer: "၄",
    },
    {
