let questions = [
    {
      question: "JavaScript မှာ const ကို ဘာကြောင့်သုံးရတာလဲ?",
      options: ["variable တန်ဖိုးကို မပြောင်းလဲချင်လို့", "တန်ဖိုးကို အချိန်မရွေး ပြောင်းလဲဖို့", "loop ထဲမှာ သုံးဖို့ "],
      answer: "variable တန်ဖိုးကို မပြောင်းလဲချင်လို့",
    },
    {
      question: "looping ဘယ်နှစ်ခုရှိိလဲ။",
      options: ["၇", "၆", "၅"],
      answer: "၅",
    },
    {
      question: "ဘယ် loop က လွယ်ကူတာလဲ",
      options: ["for loop", "while loop", "for in loop"],
      answer: "for loop",
    },
    {
      question: "javascrip မှာ li ကို အသစ်လုပ်ချင်ရင် ဘယ်လို ရေးရလဲ။",
      options: ["innerHtml", "textcontent", "queryselctor"],
      answer: "innerHtml",
    },
    {
        question: "စိတ်ဝင်စားတဲ့ သူအတွက် ဘယ်အရာကို ပထမ လေ့လာသင့်လဲ။",
        options: ["html", "css", "javascrip"],
        answer: "html",
      },
  ];
